class Api::V1::AddressesController < ApplicationController
  ...
  def create
    begin
      ...
      render json: {
        status: 422, message: I18n.t('errors.already_associated_error'), associated_address: e.address
      }, status: :unprocessable_entity
    rescue CepExceptions::AddressValidationError => e
      render json: {
        status: 422, message: I18n.t('errors.address_validation_error', errors: e.message)
      }, status: :unprocessable_entity
